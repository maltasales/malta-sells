...
import { ArrowLeft, Scale, Truck, Building, Wrench, Sparkles, Sofa } from 'lucide-react';
...
const services = [
  {
    ...
    icon: Sofa,
    image: 'https://images.pexels.com/photos/1866149/pexels-photo-1866149.jpeg?w=800&h=600&fit=crop',
    providers: ['IKEA Malta', 'Home Centre', 'Living Space Malta']
  },
  {
    id: 'legal',
    name: 'Legal Services',
